                    ...
                    <div class="row">
                        <div class="col-md-2_3 offset-md-1_3">
                            <div class="section-headline">
                                <h1>About</h1>
                                <hr>
                                <p>Our company has been developing <span class="accent-color">high-quality</span> and
                                    <span class="accent-color">fast websites</span> for corporate needs since 2021. We
                                    are <span class="accent-color">renowned professionals</span> of website development.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="brand-in-numbers-container">
                    ...
                    <div class="marquee marquee-absolute-center">
                        <div class="marquee-item" data-dir='left'>
                            <div class="marquee-row">SLE — SLE — SLE — SLE — SLE — SLE — SLE — SLE — SLE — SLE — SLE —
                                SLE — SLE — SLE — SLE — SLE — SLE — SLE — SLE — SLE — SLE — </div>
                            <div class="marquee-row">SLE — SLE — SLE — SLE — SLE — SLE — SLE — SLE — SLE — SLE — SLE —
                                SLE — SLE — SLE — SLE — SLE — SLE — SLE — SLE — SLE — SLE — </div>
                        </div>
                    </div>
                            ...
                            <div class="team-member-item tmi-collection anim-1_4-item">
                                <div class="tmi-photo-collection">
                                    ...
                                    <div class="tmi-photo aspect-ratio _3x4 crh">
                                        <img src="{{ asset('assets/img/t1.jpg') }}" class="lazy _cover ar-abs"
                                            alt="">
                                            ...
                                            <li>
                                                <a href="#!" aria-label="Instagram" rel="noopener nofollow">
                                                    <svg width="32" height="32" viewBox="0 0 448 512">
                                                        <use
                                                            xlink:href="{{ asset('assets/img/sprite.svg') }}#instagram-icon">
                                                        </use>
                                                    </svg>
                                                </a>
                                            </li>
                        ...
                        <div class="col-lg-1_4 col-md-1_3 col-sm-1_2">
                            <div class="team-member-item tmi-collection anim-1_4-item">
                                <div class="tmi-photo-collection">
                                    <div class="el-collection"></div>
                                    <div class="tmi-photo aspect-ratio _3x4 crh">
                                        <img src="{{ asset('assets/img/t2.jpg') }}" class="lazy _cover ar-abs"
                                            alt="">
                                        <ul class="social-links tmi-sl-bordered">
                                            <li>
                                                <a href="#!" aria-label="Facebook" rel="noopener nofollow">
                        ...
                        <div class="col-lg-1_4 col-md-1_3 col-sm-1_2">
                            <div class="team-member-item tmi-collection anim-1_4-item">
                                <div class="tmi-photo-collection">
                                    <div class="el-collection"></div>
                                    <div class="tmi-photo aspect-ratio _3x4 crh">
                                        <img src="{{ asset('assets/img/t3.jpg') }}" class="lazy _cover ar-abs"
                                            alt="">
                                        <ul class="social-links tmi-sl-bordered">
                                            <li>
                                                <a href="#!" aria-label="Facebook" rel="noopener nofollow">
                        ...
                        <div class="col-lg-1_4 col-md-1_3 col-sm-1_2">
                            <div class="team-member-item tmi-collection anim-1_4-item">
                                <div class="tmi-photo-collection">
                                    <div class="el-collection"></div>
                                    <div class="tmi-photo aspect-ratio _3x4 crh">
                                        <img src="{{ asset('assets/img/t4.jpg') }}" class="lazy _cover ar-abs"
                                            alt="">
                                        <ul class="social-links tmi-sl-bordered">
                                            <li>
                                                <a href="#!" aria-label="Facebook" rel="noopener nofollow">
                    ...
                    <div class="row">
                        <div class="col-md-2_3 offset-md-1_3">
                            <div class="section-headline">
                                <h2 style="">Brands</h2>
                                <hr
                                    style="translate: none; rotate: none; scale: none; transform-origin: 551.992px 0.5px; transform: translate(0px, 0px);">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2_3 offset-md-1_3">
                            <div class="brands-carousel-outer brands-carousel-left-nav anim-1_1-item"
                                ...
                                <div class="brands-carousel flickity-enabled is-draggable" tabindex="0">
                                    <div class="flickity-viewport" style="height: 446.156px; touch-action: pan-y;">
                                        <div class="flickity-slider"
                                            style="left: 0px; transform: translateX(-299.66%);">
                                            <div class="brands-carousel-item is-selected"
                                                style="position: absolute; left: 299.66%;">
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white1.svg" alt="">
                                                </div>
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white2.svg" alt="">
                                                </div>
                                            </div>
                                            <div class="brands-carousel-item is-selected"
                                                style="position: absolute; left: 324.74%;">
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white5.svg" alt="">
                                                </div>
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white6.svg" alt="">
                                                </div>
                                            </div>
                                            <div class="brands-carousel-item is-selected"
                                                style="position: absolute; left: 349.71%;">
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white7.svg" alt="">
                                                </div>
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white8.svg" alt="">
                                                </div>
                                            </div>
                                            <div class="brands-carousel-item is-selected"
                                                style="position: absolute; left: 374.68%;">
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white3.svg" alt="">
                                                </div>
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white4.svg" alt="">
                                                </div>
                                            </div>
                                            <div class="brands-carousel-item" aria-hidden="true"
                                                style="position: absolute; left: 399.66%;">
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white1.svg" alt="">
                                                </div>
                                            ...
                                            <div class="brands-carousel-item" aria-hidden="true"
                                                style="position: absolute; left: 124.97%;">
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white5.svg" alt="">
                                                </div>
                                            ...
                                            <div class="brands-carousel-item" aria-hidden="true"
                                                style="position: absolute; left: 149.94%;">
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white7.svg" alt="">
                                                </div>
                                            ...
                                            <div class="brands-carousel-item" aria-hidden="true"
                                                style="position: absolute; left: 174.91%;">
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white3.svg" alt="">
                                                </div>
                                            ...
                                            <div class="brands-carousel-item" aria-hidden="true"
                                                style="position: absolute; left: 199.88%;">
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white1.svg" alt="">
                                                </div>
                                            ...
                                            <div class="brands-carousel-item" aria-hidden="true"
                                                style="position: absolute; left: 224.86%;">
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white5.svg" alt="">
                                                </div>
                                            ...
                                            <div class="brands-carousel-item" aria-hidden="true"
                                                style="position: absolute; left: 249.83%;">
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white7.svg" alt="">
                                                </div>
                                            ...
                                            <div class="brands-carousel-item" aria-hidden="true"
                                                style="position: absolute; left: 274.8%;">
                                                <div class="brand-item aspect-ratio">
                                                    <img class="ar-abs flickity-lazyloaded"
                                                        src="assets/img/brands/brand-white3.svg" alt="">
                                                </div>
                                ...
                                <div class="slider-dots justify-content-center justify-content-md-start">
                            ...
                            <div class="brands-grid-wrapper">
                                <div class="brands-grid-item anim-1_1-item">
                                    <div class="brand-item aspect-ratio _1x1">
                                        <img class="ar-abs" src="{{ asset('assets/img/brands/brand-white1.svg') }}"
                                            alt="DATABRAND">
                                    </div>
                                ...
                                <div class="brands-grid-item anim-1_1-item">
                                    <div class="brand-item aspect-ratio _1x1">
                                        <img class="ar-abs" src="{{ asset('assets/img/brands/brand-white2.svg') }}"
                                            alt="GARDEN">
                                    </div>
                                    <div class="brands-grid-item-content">
                                ...
                                <div class="brands-grid-item anim-1_1-item">
                                    <div class="brand-item aspect-ratio _1x1">
                                        <img class="ar-abs" src="{{ asset('assets/img/brands/brand-white3.svg') }}"
                                            alt="ACACIA">
                                    </div>
                                    <div class="brands-grid-item-content">
                                ...
                                <div class="brands-grid-item anim-1_1-item">
                                    <div class="brand-item aspect-ratio _1x1">
                                        <img class="ar-abs" src="{{ asset('assets/img/brands/brand-white4.svg') }}"
                                            alt="nature">
                                    </div>
                                    <div class="brands-grid-item-content">
                                ...
                                <div class="brands-grid-item anim-1_1-item">
                                    <div class="brand-item aspect-ratio _1x1">
                                        <img class="ar-abs" src="{{ asset('assets/img/brands/brand-white5.svg') }}"
                                            alt="BUSINESS NAME">
                                    </div>
                                    <div class="brands-grid-item-content">
                                ...
                                <div class="brands-grid-item anim-1_1-item">
                                    <div class="brand-item aspect-ratio _1x1">
                                        <img class="ar-abs" src="{{ asset('assets/img/brands/brand-white6.svg') }}"
                                            alt="PARIATUR">
                                    </div>
                                    <div class="brands-grid-item-content">
                                ...
                                <div class="brands-grid-item anim-1_1-item">
                                    <div class="brand-item aspect-ratio _1x1">
                                        <img class="ar-abs" src="{{ asset('assets/img/brands/brand-white7.svg') }}"
                                            alt="COMPANY">
                                    </div>
                                    <div class="brands-grid-item-content">
                                ...
                                <div class="brands-grid-item anim-1_1-item">
                                    <div class="brand-item aspect-ratio _1x1">
                                        <img class="ar-abs" src="{{ asset('assets/img/brands/brand-white8.svg') }}"
                                            alt="COFFEE CORNER">
                                    </div>
                                    <div class="brands-grid-item-content">
                            ...
                            <div class="row">
                                <div class="col-sm-1 col-lg-1_3">
                                    <div class="contacts-item">
                                        ...
                                        <ul class="list-style-none ci-list">
                                            <li>
                                                <a href="https://goo.gl/maps/Zh61f9uBZH6RXeZj6" class="crs"
                                                    rel="noopener">
                                ...
                                <div class="col-sm-1_2 col-lg-1_3">
                                    <div class="contacts-item">
                                        ...
                                        <ul class="list-style-none ci-list">
                                            <li><a href="tel:+13239134688" class="formingHrefTel crs">+1
                                                    323-913-4688</a></li>
                                            <li><a href="tel:+13238884554" class="formingHrefTel crs">+1
                                                    323-888-4554</a></li>
                                        </ul>
                                    </div>
                                </div>
