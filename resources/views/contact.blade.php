<!DOCTYPE html><html lang="en">
    ...
    <title>Contact - MargX - simplicity and lack of exces</title>
...
<body>
    ...
    <div class="container">
		...
		<article class="main-body">
			...
			<section class="section contacts form-outer">
    <div class="container">
        <div class="row">
            <div class="col-md-2_3 offset-md-1_3">
                <div class="section-headline form-success-hidden">
                    <h1>Get in touch</h1>
                    <hr>
                </div>
                <div class="section-headline form-success-visible" aria-hidden="true">
        ...
        <div class="row section-trigger">
            <div class="col-md-1_3">
                <div class="contacts-items contacts-items-center contacts-items-large">
                    <div class="contacts-row gy-2">
            ...
            <div class="col-md-2_3">
                <form action="#!" method="post" class="contact-form contact-form-m0" novalidate>
                    ...
                    <div class="row align-items-center">
                        <div class="col-1">
                            <div class="btn-arrows form-success-hidden">
                                <div class="btn-default btn-center">
                                    ...
                                    <button type="submit" class="btn crm mc"><span>Submit</span></button>
                            ...
                            <div class="col-sm-1_2 order-1 order-sm-2 item form-success-visible" aria-hidden="true">
