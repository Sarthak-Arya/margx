...
<link rel="preload" href="{{ asset('assets/fonts/playfair-display-v30-latin/playfair-display-v30-latin-900.woff2') }}" as="font" type="font/woff2" crossorigin> --}}
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@400;700&family=Montserrat:wght@500;600;700&family=Playfair+Display:ital,wght@0,400;0,900;1,400&display=swap"
        rel="stylesheet">
    ...
    <main class="main">
                                ...
                                <div class="lang">
                                    <div class="lang-current crs">
                                        ...
                                        <svg width="11" height="7" viewBox="0 0 11 7"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M9.71667 -5.60963e-08L11 1.32432L5.5 7L-5.78881e-08 1.32432L1.28333 -4.24729e-07L5.5 4.35135L9.71667 -5.60963e-08Z"
        ...
        <article class="main-body">
                            ...
                            <div class="intro-details-right">
                                <div class="btn-outer btn-center intro-btn-waves-mob-right">
                                    ...
                                    <a href="#!" class="btn btn-main crh btn-icon-r45">
                                        <div class="btn-icon"><svg class="cd-icon" width="85" height="103"
                                                viewBox="0 0 85 103" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <div class="btn-waves btn-waves-bottom"><span></span><span></span><span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container bin-container">
                    <div class="marquee">
                        <div class="marquee-item" data-dir='left'>
                            <div class="marquee-row">MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX —
                                MARGX — MARGX — MARGX —
                                MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — </div>
                            <div class="marquee-row">MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX —
                                MARGX — MARGX — MARGX —
                                MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — </div>
                        </div>
                        ...
                        <div class="col-lg-1_3 col-g b-none b-lg-block">
                            <div class="btn-outer btn-center btn-anim">
                                ...
                                <div class="btn-circle-spikes">
                                    <svg viewBox="0 0 342 342">
                                        <use xlink:href="{{ asset('assets/img/sprite.svg') }}#circle-spikes"></use>
                                    </svg>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="marquee">
                    <div class="marquee-item" data-dir='left'>
                        <div class="marquee-row">MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX
                            — MARGX — MARGX — MARGX
                            — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — </div>
                        <div class="marquee-row">MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX
                            — MARGX — MARGX — MARGX
                            — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-3_4 offset-xl-1_4">
                            <div class="row nitems">
                                    ...
                                    <div class="pricing-item pricing-anim el-collection-hover anim-1_3-item">
                                        <div class="el-collection-content">
                                            <header class="pricing-item-header">
                                                ...
                                                <div class="pricing-item-price"><small class="b-block">from</small>
                                                    899$</div>
                                            </header>
                                            <div class="pricing-item-h">
                                                <div class="pricing-item-content">
                                                    <ul class="list-style-none pricing-item-list">
                                                        <li class="active">
                                                            <svg width="18" height="18" viewBox="0 0 18 19">
                                                                <use
                                                                    xlink:href="{{ asset('assets/img/sprite.svg') }}#star2">
                                                                </use>
                                                            </svg>
                                                            Concept development
                                                        </li>
                                ...
                                <div class="col-sm-1_2 col-lg-1_3">
                                    <div
                                        class="pricing-item pricing-item-accent pricing-anim el-collection-hover anim-1_3-item">
                                        <div class="el-collection-content">
                    ...
                    <div class="testimonials-carousel anim-1_1-item">
                        <div class="testimonials-item">
                            ...
                            <div class="testimonials-item-details">
                                ...
                                <p class="testimonials-item-desc">When users decide what to do, where to go, or what to
                                    buy, they turn to Google. Your ad may appear when they are looking for the products
                                    or services that you offer. An ad displayed on a computer or mobile device can bring
                                    you valuable new customers.</p>
                            </div>
                        </div>
                        <div class="testimonials-item">
                            <div class="testimonials-item-photo">
                    ...
                    <div class="slider-nav justify-content-center anim-1_1-item">
                        <div class="slider-btn slider-btn-prev crm">
                            <svg viewBox="0 0 18 14" width="18" height="14">
                                <use xlink:href="{{ asset('assets/img/sprite.svg') }}#arrow-prev"></use>
                            </svg>
                        </div>
                        ...
                        <div class="slider-btn slider-btn-next crm">
                            <svg viewBox="0 0 18 14" width="18" height="14">
                                <use xlink:href="{{ asset('assets/img/sprite.svg') }}#arrow-next"></use>
                            </svg>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="seo-content-hidden" style="max-height: 0px;">
                                    <div class="article">
                                        <p>This is why you should try to test each sub task you identified during your
                                            task-breakdown by itself. Only after you’re confident that each part works
                                            as you expect you can attempt to plug them together. Make sure you test the
                                            complete program as well, errors can creep in in the way the different parts
                                            interact. You should try to automate your tests. The easier it is to test
                                            your program, the freer you are in experimenting with changes.</p>
                                        <h2>Benefits Of ASync/Await In Programming</h2>
                                        <p>Learning to program means learning how to solve problems using code.
                                            Conceptually it is not very difficult to write a program that solves a
                                            problem that you can solve yourself. The skill you need to acquire is
                                            thinking very precisely about how you solve the problem and breaking it down
                                            into steps that are so simple that a computer can execute them. I encourage
                                            you to first solve a few instances of a problem by hand and think about what
                                            you did to find the solution. For example if the task is sorting lists, sort
                                            some short lists yourself.</p>
                                        <p>A reasonable method would be to find the smallest element, write it down and
                                            cross it out of the original list and repeat this process until you have
                                            sorted the whole list. Then you have to teach the computer 1) how to find
                                            the smallest element, 2) how to write it down, 3) how to cross it out, and
                                            wrap this in a loop. Then continue this task breakdown process until you’re
                                            confident you know how to write the necessary program.</p>
                                        <h3>ASync/Await In Programming</h3>
                                        <p>To make good progress in your programming task, you need to test your work as
                                            early and as thoroughly as possible. Everybody makes mistakes while
                                            programming and finding mistakes in programs consumes a very large part of a
                                            programmer’s work-day. Finding a problem in a small and easy piece of code
                                            is much simpler than trying to spot it in a large program. </p>
                                        <ul>
                                            <li>Consulting</li>
                                    ...
                                    <div class="seo-btn seo-content-btn">
                                        <div class="btn btn-min crm mc">
                                            <div></div>
                                        </div>
                                    </div>
                            ...
                            <div class="text-circle contacts-text-circle">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    ...
                                    <path d="M 250, 250m -250, 0a 250,250 0 0,1 500,0a 250,250 0 0,1 -500,0"
                                        fill="none" id="contacts-textcircle"></path>
                                    <text dy="40" textLength="300%">
                                        <textPath xlink:href="#contacts-textcircle" textLength="300%">Don’t worry,
                                            it's will be WOW.</textPath>
                                    </text>
                                </svg>
                            </div>
                        </div>
                                    ...
                                    <div class="btn-arrows btn-arrows-contacts">
                                        <div class="btn-default btn-center">
                                            <div class="btn-arrow btn-arrow-animate btn-arrow-prev">
                                                <svg viewBox="0 0 103 85" height="0">
                                                    <use
                                                        xlink:href="{{ asset('assets/img/sprite.svg') }}#arrow-right">
                                                    </use>
                                                </svg>
                                            </div>
                                            <div class="btn btn-popup-open crm mc" data-popup-id="#popup-contacts">
                                                <span>Get in touch</span>
                                            </div>
                                            <div class="btn-arrow btn-arrow-animate btn-arrow-next">
                                                <svg viewBox="0 0 103 85">
                                                    <use
                                                        xlink:href="{{ asset('assets/img/sprite.svg') }}#arrow-right">
                                                    </use>
                                                </svg>
                            ...
                            <div class="col-md-2_3 offset-md-1_3">
                                <div class="popup-content popup-anim form-outer">
                                    <div class="popup-header">
                                        ...
                                        <div class="popup-subheading form-success-visible" aria-hidden="true">Sent
                                        </div>
                                    </div>
                                    <div class="popup-body">
                                        <h2 class="popup-heading form-success-hidden">Text to us</h2>
                                        <h2 class="popup-heading form-success-visible" aria-hidden="true">Your request
                                            has been sent successfully</h2>
                                            ...
                                            <div class="row gy-3 form-success-hidden">
                                                <div class="col-sm-1_2">
                                                    <div class="form-field">
                                                        ...
                                                        <input type="text" class="form-control crs" name="Name"
                                                            value="" id="field-name" required
                                                ...
                                                <div class="col-sm-1_2">
                                                    <div class="form-field">
                                                        ...
                                                        <input type="tel" class="form-control crs" name="Phone"
                                                            value="" id="field-tel" required
                                                ...
                                                <div class="col-1">
                                                    <div class="form-field">
                                                        ...
                                                        <input type="email" class="form-control crs" name="Email"
                                                            value="" id="field-email" required
                                                ...
                                                <div class="col-1">
                                                    <div class="form-field">
                                                        <label for="field-message" class="form-label">How can we help
                                                            you?</label>
                                                        <textarea name="Message" class="form-control crs" cols="30" rows="1" id="field-message"
                                                ...
                                                <div class="col-1">
                                                    <div class="row align-items-center">
                                                                    ...
                                                                    <li>
                                                                        <a href="#!" class="crm"
                                                                            ...
                                                                            <svg width="32" height="32"
                                                                                viewBox="0 0 448 512">
                                                                                <use
                                                                                    xlink:href="{{ asset('assets/img/sprite.svg') }}#linkedin-icon">
                                                                                </use>
                                                                            </svg>
                                                                        </a>
                                                                    </li>
                                                        ...
                                                        <div class="col-sm-1_2 order-1 order-sm-2">
                                                            <div
                                                                class="btn-default btn-waves-outer contact-btn-left form-success-hidden">
                                                            ...
                                                            <div class="btn-default contact-btn-left form-success-visible"
                                                                aria-hidden="true">
                                                                <div class="btn crm">
                                                                    <span>Thank you!</span>
                                                                </div>
                    ...
                    <div class="popup-marquee-outer b-none b-md-block">
                        <div class="popup-marquee">
                            <div class="container">
                                <div class="marquee">
                                    <div class="marquee-item" data-dir='left'>
                                        <div class="marquee-row">MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX
                                            — MARGX — MARGX —
                                            MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX —
                                            MARGX — MARGX — MARGX —
                                        </div>
                                        <div class="marquee-row">MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX
                                            — MARGX — MARGX —
                                    ...
                                    <div class="marquee-item" data-dir='right'>
                                        <div class="marquee-row"> — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX —
                                            MARGX — MARGX — MARGX
                                            — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX — MARGX —
                                            MARGX — MARGX — MARGX
                                        </div>
            ...
            <div class="container">
                <div class="cookie-message">
                    <div class="cm-content content">
                        ...
                        <p>We use cookies to understand how you use our website, to personalize content and to improve
                            your experience. By continuing to use our site, you accept our use of cookies and revised.
                                    ...
                                    <ul class="mm-list">
                                        <li>
                                            <a data-title="Home" href="{{ route('home') }}" class="crs">
                                                ...
                                                <div class="mmi-btn crs">
                                                    <svg width="0" height="0" viewBox="0 0 29 32"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M6.14959 13.9297L0.999999 18.6432L14.5 31L28 18.6433L22.8504 13.9298L18.1418 18.2397L18.1418 1L10.8583 0.999999L10.8583 18.2397L6.14959 13.9297Z" />
                                                    </svg>
                                                </div>
                                            </a>
                                            <ul>
                                                <li><a href="{{ route('home.index') }}" class="crs">Home 1</a>
                                                </li>
                                                <li><a href="{{ route('home.index2') }}" class="crs">Home 2</a>
                                                </li>
                                                <li><a href="{{ route('home.index3') }}" class="crs">Home 3</a>
                                                </li>
                                                <li><a href="{{ route('home.index4') }}" class="crs">Home 4</a>
                                                </li>
                                                <li><a href="{{ route('home.index5') }}" class="crs">Home 5</a>
                                                </li>
                                                <li><a href="{{ route('home.index6') }}" class="crs">Home 6</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a data-title="About" href="{{ route('about') }}"
                                                class="crs"><span>About</span></a>
                                        </li>
                                        <li>
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="{{ route('services') }}" class="crs">Services of
                                                        nubmers: Type 1</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('services2') }}" class="crs">Services of
                                                        nubmers: Type 2</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('services3') }}" class="crs">Services of
                                                        nubmers: Type 3</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('services4') }}" class="crs">Services of
                                                        nubmers: Type 4</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('services.icons') }}" class="crs">Services
                                                        icons: Type 1</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('services.icons2') }}" class="crs">Services
                                                        icons: Type 2</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('services.icons3') }}" class="crs">Services
                                                        icons: Type 3</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('services.single') }}" class="crs">Single
                                                        service</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="{{ route('sections.intro-slider') }}"
                                                        class="crs">Intro Slider</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('sections.image-items') }}"
                                                        class="crs">Image items</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('sections.items-of-numbers') }}"
                                                        class="crs">Items of numbers</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('sections.icon-items') }}" class="crs">Icon
                                                        items</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('sections.brand-in-numbers') }}"
                                                        class="crs">Brand in numbers</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('sections.team') }}" class="crs">Team</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('sections.gallery-classic') }}"
                                                        class="crs">Gallery Classic</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('sections.gallery-masonry') }}"
                                                        class="crs">Gallery Masonry</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('sections.pricing') }}"
                                                        class="crs">Pricing</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('sections.testimonials') }}"
                                                        class="crs">Testimonials</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('sections.brands') }}"
                                                        class="crs">Brands</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('sections.tabs-accordions') }}"
                                                        class="crs">Tabs & Accordions</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('sections.marquee') }}" class="crs">Marquee:
                                                        scrolling area of text</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('sections.content') }}"
                                                        class="crs">Content</a>
                                                </li>
                                                <li>
                                        ...
                                        <li>
                                            <a data-title="Features" href="{{ route('features.ui') }}"
                                                class="crs">
                                                <span>Features</span>
                                                <div class="mmi-btn crs">
                                                    <svg width="0" height="0" viewBox="0 0 29 32"
                                            ...
                                            <ul>
                                                <li><a href="{{ route('features.ui') }}" class="crs">UI
                                                        elements</a></li>
                                                <li><a href="{{ route('features.docs') }}"
                                                        class="crs">Documentation</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="{{ route('news') }}" class="crs">News list: Type
                                                        1</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('news2') }}" class="crs">News list: Type
                                                        2</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('news3') }}" class="crs">News list: Type
                                                        3</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('news.grid') }}" class="crs">News grid: Type
                                                        1</a>
                                                </li>
                                                <li>
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="{{ route('contact.offices') }}" class="crs">Contact –
                                                        Offices</a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="{{ route('contact2.offices') }}" class="crs">Contact
                                                        2 – Offices</a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="{{ route('contact3.offices') }}" class="crs">Contact
                                                        3 – Offices</a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="{{ route('contact4.offices') }}" class="crs">Contact
                                                        4 – Offices</a>
                                                </li>
                                            </ul>
                                        </li>
                            ...
                            <div class="col-md-1_3">
                                <div class="mm-contacts">
                                    <div class="mmc-item">
                                        ...
                                        <ul class="mmc-list">
                                            <li><a href="https://goo.gl/maps/zDnHrjo5hUooH84t7" class="crs"
                                                    rel="noopener nofollow">4730 Crystal Springs Dr, Los Angeles,
                                                    CA</a></li>
                                        </ul>
                                    </div>
                                    <div class="mmc-item">
                                    ...
                                    <div class="mmc-item">
                                        ...
                                        <ul class="mmc-list">
                                            <li><a href="mailto:mail@example.com" class="crs">mail@example.com</a>
                                            </li>
                                            <li><a href="mailto:info@example.com" class="crs">info@example.com</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="mmc-item">
                                        <ul class="social-links mm-social">
                                            <li>
                                                <a href="#!" class="crm" aria-label="Twitter"
                                                    rel="noopener nofollow">
                                                    <svg width="32" height="32"
                                            ...
                                            <li>
                                                <a href="#!" class="crm" aria-label="Facebook"
                                                    rel="noopener nofollow">
                                                    <svg width="32" height="32"
                                            ...
                                            <li>
                                                <a href="#!" class="crm" aria-label="Linkedin"
                                                    rel="noopener nofollow">
                                                    <svg width="32" height="32"
    ...
    <script>
        ...
        if (typeof SplitText === 'undefined') {
            window.SplitText = function(el, options) {
                this.chars = Array.from(el.textContent).map(char => ({
                    textContent: char
                }));
                this.words = el.textContent.split(' ').map(word => ({
                    textContent: word
                }));
            };
        }
